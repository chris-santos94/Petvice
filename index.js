...
document.addEventListener('DOMContentLoaded', function(){
    ...
    */
        ...
        //document.getElementById('userSearch').value = ''; //Clears text from search field
...
1) Build function to get image to generate the image
  Use Async function to 'await' (slow down) the response. OR, 

2) Use if/else conditional to have advice load after img


NOTE:
Initial code inside of axios.get for loading the image
